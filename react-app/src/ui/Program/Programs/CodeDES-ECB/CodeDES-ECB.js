...
import './CodeDES-ECB.css'
import { getCryptoResult } from '../../../../math_logic/CodeDES-ECB/des_ecb_code_math'
...
class CodeDESECB extends React.Component {
    state = {
        codeMessage: '',
        cryptoMatrix: null,
        isCoding: null,
                ...
                <div className="row">
                    <div className="col-md-10 col-xs-12 descr">
                        <p>
                            ...
                            использования в государственных и правительственных учреждениях США для
                            защиты от несанкционированного доступа важной, но несекретной информации.
                        </p>
                    </div>
                </div>
            </div>
